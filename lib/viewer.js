            ...
            try {
                ...
                if (files.length===1){
                    ...
                    if (typeFile==="glb"){
                        ...
                        throw new Error("the drag and drop function don't support this file model type")
                    }
                    ...
                    for (const file of files) {
                        ...
                        if (typeFile==="glb"){
                            ...
                            console.log("filemap gltf", fileMap)

                            const loader = new GLTFLoader(manager);
                            const gltf = await loader.loadAsync(fileMap[firstKey]);
                            model=gltf.scene
                            ...
                            const mtt = new MTLLoader(manager);

                            const material = await mtt.loadAsync(fileMap[secondKey]);
                            ...
                            const ambientLight = new THREE.AmbientLight(0xffffff, 0.5);
                            this.managementScene.scene.add(ambientLight);
                            ...
                            model = await this.managementScene.load.fileFBX(fileMap[fbxFileName]);
                            ...
                            model = await this.managementScene.load.fileCollada(fileMap[daeFileName]);
