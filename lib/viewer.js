...
export class viewer {
     ...
     *        }
     *        Size?:{
     *             modality?:"fullScreen" |  "customScreen",
    ...
    static async createInstance(config){
        ...
        try {
            ...
            model.ManagementRenderer.setSize(config.renderer.Size);
            ...
            model.ManagementCamera.distance = distance;

            if(config.camera.basic){
                model.ManagementCamera.setCamera(config.camera.basic);
            } else {
                model.ManagementCamera.setCamera({});
            }
            ...
            if(config.camera.controls){
                ...
                model.ManagementCamera.setControls({}, model.ManagementRenderer.renderer.domElement);
            }
