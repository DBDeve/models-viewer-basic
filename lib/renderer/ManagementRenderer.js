...
export class ManagementRenderer {
    ...
    setSize(sizeConfig){
        ...
        if(sizeConfig.modality==="fullScreen"){
        ...
        else if(sizeConfig.modality==="customScreen"){

            window.addEventListener('load', () => {
                this.customScreen(sizeConfig);
            });
    ...
    customScreen(sizeConfig){
        ...
        if(window.innerWidth >= 1200){
            ...
            if(sizeConfig.computer){
                ...
                if(sizeConfig.computer.width){
                    width= sizeConfig.computer.width;
                } else {
                    width=400;
                }

                if(sizeConfig.computer.height){
                    height = sizeConfig.computer.height;
                } else {
                    height = 400;
                }
            ...
            if(sizeConfig.tablet){
                if(sizeConfig.tablet.width){
                    width= sizeConfig.tablet.width;
                } else {
                    width=400;
                }

                if(sizeConfig.tablet.height){
                    height = sizeConfig.tablet.height;
                } else {
                    height = 400;
                }
            } else {
            ...
            if(sizeConfig.mobile){
                ...
                if(sizeConfig.mobile.width){
                    width= sizeConfig.mobile.width;
                } else {
                    width=400;
                }

                if(sizeConfig.mobile.height){
                    height = sizeConfig.mobile.height;
                } else {
                    height = 400;
                }
